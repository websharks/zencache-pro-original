...
namespace zencache // Root namespace.
{
	...
	class menu_pages // Plugin options.
	{
		...
		public function options()
		{
			...
			echo '      <p>'.sprintf(__('This feature allows you to serve some and/or ALL static files on your site from a CDN of your choosing. This is made possible through content/URL filters exposed by WordPress and implemented by %1$s. All it requires is that you setup a CDN host name sourced by your WordPress installation domain. You enter that CDN host name below and %1$s will do the rest! Super easy, and it does\'nt require any DNS changes either :-) Please <a href="http://www.websharks-inc.com/r/zencache-static-cdn-filters-general-instructions-wiki/" target="_blank">click here</a> for a general set of instructions.', $this->plugin->text_domain), esc_html($this->plugin->name)).'</p>'."\n";
			...
			echo '      <p>'.sprintf(__('<em>Note: Understanding the %1$s <a href="http://www.websharks-inc.com/r/zencache-branched-cache-structure-wiki/" target="_blank">Branched Cache Structure</a> is a prerequisite to understanding how Dynamic Version Salts are added to the mix.</em>', $this->plugin->text_domain), esc_html($this->plugin->name)).'</p>'."\n";
